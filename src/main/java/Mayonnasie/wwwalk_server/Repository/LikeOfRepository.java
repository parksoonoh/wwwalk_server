...
import Mayonnasie.wwwalk_server.walk.ModifyPinForm;
...
@Slf4j
@Repository
public class LikeOfRepository {

    public String save(String user_id, String route_id) throws SQLException {
        String sql = "insert into LIKE_OF(ROUTE_ID, USER_ID) values (?, ?)";
        ...
        try {
            ...
            log.error("likeofrepository db insert error", e);
            throw e;
        }finally {
    ...
    public String delete(String user_id, String route_id) throws SQLException {
        String sql = "delete from LIKE_OF where user_ID=? and route_id = ?";
    ...
    public String findbyid(String user_id, String route_id) throws SQLException {
        String sql = "select * from LIKE_OF where user_id = ? AND route_id = ?";
    ...
    public ArrayList<String> findByUserId(String user_id) throws SQLException {
        String sql = "select * from LIKE_OF where user_id = ?";
